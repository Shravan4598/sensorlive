...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.testing_file_path:str=os.path.join(self.data_ingestion_dir,training_pipeline.DATA_IINGESTION_INGESTED_DIR,training_pipeline.TEST_FILE_NAME)
        self.test_train_split_ratio:float=training_pipeline.DATA_INGESTION_TEST_TRAIN_SPLIT_RATION
